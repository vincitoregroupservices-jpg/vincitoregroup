        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-black-3 text-xl">
              Have questions or want to know more about Vincitore Group’s
              projects and services? We’re here to guide you every step of the
              way.
            </p>
            <p className="text-black-3 text-xl">
              Our dedicated team is always ready to assist with inquiries,
              partnerships, or investment opportunities — ensuring you get
              prompt responses and reliable solutions.
            </p>
